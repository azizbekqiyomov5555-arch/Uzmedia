...
def admin_menu_kb(uid=None):
    ...
    if uid is None or is_super_admin(uid):
        ...
        rows.append([rbtn("👤 Admin lichkasini qo'shish", style="primary")])
...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "start_qollanma":
        ...
        if vid_id:
            ...
            # Bot haqida qo'shimcha ma'lumot
            cap += (
                "\n\n"
                "━━━━━━━━━━━━━━━━━━━━\n"
                "ℹ️ <b>Bot haqida:</b>\n\n"
...
async def admin_buttons(update, context, text: str):
    ...
    if _btn_match("admin_lichka_set") or text == "👤 Admin lichkasini qo'shish":
        if not is_any_admin(uid):
            return
        ...
        await sm(context.bot, uid,
            f"👤 <b>Admin lichkasini qo'shish</b>{cur_info}\n\n"
            f"Admin <b>username</b>ini kiriting (masalan: @username)\n"
...
async def media_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_any_admin(uid) and state == "set_admin_lichka":
