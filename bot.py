...
def build_auto_post_caption(movie: dict, code: str, ep_count: int, finished: bool = False) -> str:
    title = movie.get("title", code)
    if finished:
        header = "🟢 <b>To'liq yuklandi</b>"
        status = f"✅ Jami qismlar: <b>{ep_count} ta</b>"
    else:
        header = "🟡 <b>Yuklanmoqda...</b>"
        status = f"➕ Hozirgacha: <b>{ep_count} qism</b> qo'shildi"
    return (
        f"{header}\n"
        "┏╋━━━━━━◥◣◆◢◤━━━━━━╋┓\n"
        f"        <b>{title}</b>\n"
        ...
        "┗━━━〔 ✦ 〕━━━┛\n\n"
        "⬇️ <b>Tomosha qilish uchun pastdagi tugmani bosing</b>"
    )
...
async def auto_post_episode_added(bot, code: str, finished: bool = False):
    ...
    try:
        ...
        caption = build_auto_post_caption(movie, code, ep_count, finished=finished)
