    ...
    if data == "start_qollanma":
        ...
        if vid_id:
            ...
            cap += (
                ...
                "3️⃣ To'ldirmoqchi bo'lgan <b>summani</b> kiriting\n"
                "4️⃣ Sizga <b>to'lov havolasi</b> keladi — bosing\n"
                "5️⃣ Karta ma'lumotlaringizni kiriting va to'lang\n"
                "✅ To'lov o'tishi bilan balans <b>avtomatik</b> hisobingizga qo'shiladi!"
                "</blockquote>"
            )
