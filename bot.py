...
LOCAL_BACKUP_FILE = os.environ.get("DATA_DIR", "/data") + "/db_backup.json"
LOCAL_MOVIES_FILE = os.environ.get("DATA_DIR", "/data") + "/movies_backup.json"

logging.basicConfig(format="%(asctime)s | %(levelname)s | %(message)s", level=logging.INFO)

# ── /data papkasini yaratish (Railway Volume) ─────────────
